...
if __name__ == "__main__":
    ...
    for vid_name in detections.keys():
        for frame_id in detections[vid_name].keys():
            ...
            # Read image
            if 'MOT' or 'BEE' in args.data_path:
...
# --data_path /media/lsw/data42/DanceTrack/test/ --pickle_path ../outputs/det/dance_test_0.80.pickle --output_path ../outputs/det_feat/dance_test_0.80.pickle --config_path configs/DanceTrack/sbs_S50.yml --weight_path /home/lsw/PycharmProjects/SpikeYOLOX/SpikeTrackTrack/FastReID/weights/dance_sbs_S50.pth