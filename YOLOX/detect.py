...
def make_parser():
    ...
    parser.add_argument("-c", "--ckpt", default="/home/lsw/PycharmProjects/SpikeYOLOX/SpikeTOPIC-weights/yolox-s/MOT17-Mix/D4/t4/mot17_mix_s_t4.pth.tar",
...
def main(exp, args, num_gpu):
    ...
    output_dir = os.path.dirname(args.exp_name)
...
# -f exps/yolox_s_bee24_test.py -c /home/lsw/PycharmProjects/SpikeYOLOX/SpikeTOPIC-weights/yolox-s/BEE24/D4/t4/yolox_s_bee_t4.pth.tar --nms 0.80 -n ../outputs/det/bee24_test_0.80.pickle -b 1 -d 1 --fp16 --fuse
# -f /home/lsw/PycharmProjects/SpikeYOLOX/SpikeTrackTrack/YOLOX/exps/yolox_s_mot17_test.py -c /home/lsw/PycharmProjects/SpikeYOLOX/SpikeTOPIC-weights/yolox-s/MOT17-Mix/D4/t4/mot17_mix_s_t4.pth.tar --nms 0.80 -n ../outputs/det/mot17_test_0.80.pickle -b 1 -d 1 --fp16 --fuse