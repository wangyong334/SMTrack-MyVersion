...
def set_parameters(args, vid_name, mode):
    ...
    elif 'BEE' in vid_name:
        if mode == 'val':
            args.pickle_path = args.pickle_dir + 'bee24_val_0.80.pickle'
            args.pickle_path_95 = args.pickle_dir + 'bee24_val_0.95.pickle'
            args.data_path = args.data_dir + 'BEE24/val/'
        else:
            args.pickle_path = args.pickle_dir + 'bee24_test_0.80.pickle'
            args.pickle_path_95 = args.pickle_dir + 'bee24_test_0.95.pickle'
            args.data_path = args.data_dir + 'BEE24/test/'

            # Baseline Setting
            args.det_thr = 0.60
            args.init_thr = 0.60
            args.match_thr = 0.70 if mode == 'val' else 0.60
