...
def make_parser():
    ...
    # Basic
    parser.add_argument("--pickle_dir", type=str, default="../outputs/det_feat/")
    parser.add_argument("--output_dir", type=str, default="../outputs/track/")
    parser.add_argument("--data_dir", type=str, default="/media/lsw/data42/")
